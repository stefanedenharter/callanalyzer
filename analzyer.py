...
st.markdown(
    ...
    <div class="version-badge">🔖 Version 2.0.0 (Plotly Interactive)</div>
    """,
...
def plotly_stacked_side_by_side(df, group_col, group_order, call_order, title, xaxis_title):
    # Prepare dataframes for counts and durations
    counts = (
    ...
    # Colors consistent with Plotly default qualitative palette
...
if "df_all" in st.session_state:
    ...
    with col3:
        # Include last 12 months in options to keep them visible even if no data yet
    ...
    if df_filtered.empty:
        ...
        # Monthly chart uses last 12 months always
